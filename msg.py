...
token_not_found = 'Токен не найден, проверьте правильность написания и повторите попытку'
tip_to_librarian_1 = 'Чтобы ответить читателю, нажмите на кнопку с номером его запроса'
lib_ans_btn_sorry_no_book = 'Книга у другого читателя, приносим свои извинения'
lib_ans_book_avail = 'книга в наличии в библиотеке. Если вы нажмете на "Зарезервировать", то сможете забрать её в течении двух дней.'
lib_ans_btn_book_avail = 'книга есть в наличии'
lib_ans_book_unavail = '\n\nКнига у другого читателя, приносим свои извинения\n Чтобы найти другую книгу введите /find_book'
req_send_reader_tip = 'запрос отпрален, чтобы найти другую книгу введите /find_book'
get_book_instructions_to_reader = 'Вы можете забрать книгу в течение 2 дней.\nЕсли вы не зарегистрированы в библиотеке, возмите с собой паспорт. Если вам нет 14 лет, приходите с родителями.\n/reserved_books Посмотреть все книги которые вас ожидают'